...
const Health: React.FC = () => {
  const { status, isHealthy, isLoading, error } = useHealthStatus();
            ...
            {status && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-600">{status.version || 'Unknown'}</p>
                </div>
                
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-medium text-gray-900 mb-2">Database</h3>
                  <p className="text-gray-600">{status.database || 'Unknown'}</p>
                </div>
                
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-medium text-gray-900 mb-2">Redis</h3>
                  <p className="text-gray-600">{status.redis || 'Unknown'}</p>
                </div>
